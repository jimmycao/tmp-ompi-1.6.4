...
#define MCA_io_romio_COMPLETE_CONFIGURE_FLAGS " CFLAGS='-DNDEBUG -g -O2 -finline-functions -fno-strict-aliasing -pthread' CPPFLAGS='  -I/root/soft/openmpi-1.6.4/opal/mca/hwloc/hwloc132/hwloc/include   -I/usr/include/infiniband -I/usr/include/infiniband' FFLAGS='' LDFLAGS=' ' --enable-shared --disable-static  --prefix=/root/program/orte --with-mpi=open_mpi --disable-aio"
...
#define OPAL_PACKAGE_STRING "Open MPI root@node1.pivotal.com Distribution"
